...
public class EducationlevelController {
	...
	public ModelAndView index(ModelMap model, HttpServletRequest request){
    	model.addAttribute("title_for_layout", "Nível de Escolaridade");
    	return new ModelAndView(this.alias + "/index", "educationlevels", educationlevelService.find("all"));
	}

	@RequestMapping(value = "/add", method = RequestMethod.GET)
	public ModelAndView add(@ModelAttribute("Educationlevel") Educationlevel educationlevel, ModelMap model) {
	...
	public ModelAndView edit(@PathVariable(value="id") Integer id, @ModelAttribute Educationlevel educationlevel, ModelMap model) {
		...
		Educationlevel _educationlevel = educationlevelService.findBy("id", id + "");
	...
	public String delete(@PathVariable(value="id") Integer id, @ModelAttribute Educationlevel educationlevel, ModelMap model) {
		...
		educationlevelService.delete(educationlevelService.findBy("id", id+""));
