...
<form:form method="post" action="${root}${action}" modelAttribute="${model}" commandName="${model}">
	<div class="row">
		<div class="col-md-8">
			<div class="panel panel-default">
				...
				<div class="panel-body form-horizontal">
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:input path="first_name" value="${doctor.individual.first_name}" class="form-control" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:input path="last_name" value="${doctor.individual.last_name}" class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:input path="cpf" value="${doctor.individual.cpf}" class="form-control" maxlength="11" required="required" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:input path="birthday" value="${doctor.individual.birthday}" class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:input path="email" value="${doctor.individual.email}" class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:select path="skin_id" items="${skins}" value="${doctor.individual.skin_id}" class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:select path="educationlevel_id" items="${educationlevels}" value="${doctor.individual.educationlevel_id}" class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:select path="civilstatus_id" items="${civilstatus}" value="${doctor.individual.civilstatus_id}" class="form-control" />
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h1 class="panel-title">Dados Profissionais</h1>
				</div>
